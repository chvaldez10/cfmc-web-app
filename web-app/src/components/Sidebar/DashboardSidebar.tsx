...
const Sidebar = () => {
  ...
  return (
    <div
      className={`h-screen bg-gray-900 text-gray-100 flex flex-col ${
        ...
        <nav className="mt-10">
          {navElements.map((navElement) => (
            <Link href={navElement.href} key={navElement.title}>
              <div
                className={`flex items-center py-2.5 px-4 rounded transition duration-300 hover:bg-gray-700 hover:text-blue-400 ${
