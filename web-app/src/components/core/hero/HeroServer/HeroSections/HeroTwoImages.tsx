      ...
      <Grid containerClassName="grid grid-cols-2 gap-2 items-start lg:order-first order-last">
        <Flex containerClassName="flex pt-24 justify-start sm:justify-end lg:justify-center">
          <NextImage
            ...
            src="https://skdambngwkjvsmkhgswi.supabase.co/storage/v1/object/public/images/ministry/3.jpg"
        ...
        <NextImage
          width="w-full"
          height={IMAGE_SIZE_SMALL_HERO}
          src="https://skdambngwkjvsmkhgswi.supabase.co/storage/v1/object/public/images/ministry/2.jpg?t=2024-09-27T03%3A30%3A08.492Z"
