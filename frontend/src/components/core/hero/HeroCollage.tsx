...
const HeroCollage: FC = () => {
  return (
    <div className="w-full bg-purple-50">
      ...
      >
        {/* Image Column */}
        <div className="grid grid-cols-2 grid-rows-3 gap-2 md:gap-7 w-full md:w-2/3">
        ...
        <div className="w-full md:w-1/3 flex flex-col items-center text-center md:text-left">
          ...
          <p className="w-full md:w-3/4 text-base 2xl:text-xl p-4 bg-purple-100 text-gray-600 border-r-4 border-l-4 border-purple-500 shadow-lg rounded-md mb-4 md:mb-0">
