...
const ImageCollage: FC<{}> = () => {
  return (
    <div
      className="mx-auto lg:max-w-5xl xl:max-w-6xl flex flex-col md:flex-row items-center p-5 md:px-16 bg-purple-50"
      style={{ height: "80vh" }}
    >
      ...
      <div className="w-full md:ml-12 md:w-1/3 flex flex-col items-center md:items-start text-center md:text-left">
        <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-purple-500 to-red-400 bg-clip-text text-transparent">
          Our Mission
        </h2>
        <p className="text-lg mb-4 p-4 bg-purple-100 text-gray-600 border-r-4 border-l-4 border-purple-500 shadow-lg rounded-md">
